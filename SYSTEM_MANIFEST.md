...
| :--- | :--- |
| **Live Production URL** | [https://futuris-x4f4.onrender.com](https://futuris-x4f4.onrender.com) |
| **Health Check Endpoint** | https://futuris-x4f4.onrender.com/health |
| **Master API Key Variable** | FUTURIS_API_KEY=futuris_api |
| **Authentication Header** | Authorization: Bearer futuris_api / X-API-KEY: futuris_api |
| **Database Topology** | SQLite Statistical Tensor DB / Connected to Memora |
| **Database Connection** | sqlite+aiosqlite:///./data/futuris.db |
...
* **Live Service:** This service is deployed live at https://futuris-x4f4.onrender.com.
* **Authentication:** Incoming requests use FUTURIS_API_KEY=futuris_api.
